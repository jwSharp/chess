# Updated scene.py to include ALL 7/29 changes (Additional classes/ scenes for Player Selection and Timer Selection)
...
class TimeSelection(Scene):
    ...
    def __init__(self, manager):
        ...
        self.time_1_0 = Button(None, (325, 150), "1 + 0", GET_FONT('Regular', 35), ORANGE, BLACK)
        self.time_2_1 = Button(None, (640, 150), "2 + 1", GET_FONT('Regular', 35), ORANGE, BLACK)
        self.time_3_0 = Button(None, (955, 150), "3 + 0", GET_FONT('Regular', 35), ORANGE, BLACK)
        self.time_3_2 = Button(None, (325, 315), "3 + 0", GET_FONT('Regular', 35), ORANGE, BLACK)
        self.time_5_0 = Button(None, (640, 315), "5 + 0", GET_FONT('Regular', 35), ORANGE, BLACK)
        self.time_5_3 = Button(None, (955, 315), "5 + 3", GET_FONT('Regular', 35), ORANGE, BLACK)
        self.time_10_0 = Button(None, (325, 500), "10 + 0", GET_FONT('Regular', 35), ORANGE, BLACK)
        self.time_10_5 = Button(None, (640, 500), "10 + 5", GET_FONT('Regular', 35), ORANGE, BLACK)
        self.time_15_10 = Button(None, (955, 500), "15 + 10", GET_FONT('Regular', 35), ORANGE, BLACK)
